        ...
        <footer class="footer p-10 bg-neutral bg-gradient-to-r from-blue-500 to-blue-900 text-white">
            ...
            <div class="grid grid-cols-1 xl:grid-cols-3">
                <div class="p-2 w-80">
                    ...
                    <br /> 
                    <a class="link link-hover p-2" href="/brand/nike">Nike</a>
                    <a class="link link-hover p-2" href="/brand/adidas">Adidas</a>
                    <a class="link link-hover p-2" href="/brand/puma">Puma</a>
                    <a class="link link-hover p-2" href="/brand/under-armour">Under Armour</a>
                </div> 
                <div class="p-2 w-80">
