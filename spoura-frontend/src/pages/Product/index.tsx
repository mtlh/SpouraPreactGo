			...
			<div class="py-12 px-8 m-auto grid grid-cols-1 md:grid-cols-2 max-w-7xl min-h-screen">
                ...
                <div class="mx-6 my-2">
                    ...
                    <div class="flex space-x-2 rounded-xl p-2 m-auto">
                        { addCartLoading ?
                            <button 
                                class="bg-slate-200 text-white rounded-lg hover:scale-110 border-0 py-2 px-4 my-4 h-12 w-40 shadow-lg">
                                <LoadingSpinner width="2rem" height="2rem" />
                            </button>
                        :
                            <button 
                                onClick={async ()=> {setAddCartLoading(true); updateCart(await AddToCart(productData.URLSlug, quantity, size), setUser, setAddCartLoading);}}
                                class="btn bg-gradient-to-r from-blue-500 to-blue-900 text-white rounded-lg hover:scale-110 border-0 py-2 px-4 my-4 h-12 w-40 shadow-lg">
                                    ADD TO CART
                            </button>
                        }
...
export const updateCart = (newCart, setUser, setAddCartLoading) => {
    setUser((prevUser) => ({
        ...prevUser,
        Cart: newCart,
    }));
