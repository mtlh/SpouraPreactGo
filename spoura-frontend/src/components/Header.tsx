		...
		<div class="navbar bg-base-100 sticky shadow-xl top-0 z-50">
			...
			<div class="dropdown">
				...
				<ul tabindex={0} class="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-96">
					...
					<a class="font-base underline text-md" href="/shop?sort=Trending">Trending</a>
					<a class="font-base underline text-md" href="/shop?sort=All">All</a>
					</li>
					<li tabindex={0} class="grid grid-cols-3 py-2">
					<div class="font-semibold text-lg col-span-3">Brands</div>
					<a class="font-base underline text-md" href="/shop?query=Nike">Nike</a>
					<a class="font-base underline text-md" href="/shop?query=Adidas">Adidas</a>
					<a class="font-base underline text-md" href="/shop?query=Puma">Puma</a>
					<a class="font-base underline text-md" href="/shop?query=Under%20Armour">Under Armour</a>
					</li>
					<li tabindex={0} class="grid grid-cols-3 py-2">
			...
			<ul class="menu-horizontal px-1" tabindex={0}>
				...
				<div class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-gradient-to-r from-blue-500 to-blue-900">
					...
					<img src={mNav} alt="nav mens img" class="w-60" />
					<div>
					...
					<div class="grid grid-cols-1 p-2">
						...
						<a class="font-base underline text-xl" href="/shop?sort=Trending&type=Mens">Trending</a>
					...
					<div class="grid grid-cols-1 p-2">
						...
						<a class="font-base underline text-xl" href="/shop?query=Nike&type=Mens">Nike</a>
						<a class="font-base underline text-xl" href="/shop?query=Adidas&type=Mens">Adidas</a>
						<a class="font-base underline text-xl" href="/shop?query=Puma&type=Mens">Puma</a>
						<a class="font-base underline text-xl" href="/shop?query=Under%20Armour&type=Mens">Under Armour</a>
					</div>
					<div class="grid grid-cols-1 p-2">
						<div class="font-semibold text-4xl flex">
				...
				<div class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-gradient-to-r from-blue-500 to-blue-900">
					<div class="grid grid-cols-5 m-auto">
					<img src={wNav} alt="nav womens img" class="w-72" />
					<div>
					...
					<div class="grid grid-cols-1 p-2">
						...
						<a class="font-base underline text-xl" href="/shop?sort=Trending&type=Womens">Trending</a>
					...
					<div class="grid grid-cols-1 p-2">
						...
						<a class="font-base underline text-xl" href="/shop?query=Nike&type=Womens">Nike</a>
						<a class="font-base underline text-xl" href="/shop?query=Adidas&type=Womens">Adidas</a>
						<a class="font-base underline text-xl" href="/shop?query=Puma&type=Womens">Puma</a>
						<a class="font-base underline text-xl" href="/shop?query=Under%20Armour&type=Womens">Under Armour</a>
					</div>
					<div class="grid grid-cols-1 p-2">
						<div class="font-semibold text-4xl flex">
						<svg fill="#000000" class="h-8 mb-3 mr-3 fill-current text-white" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0"><g id="SVGRepo_bgCarrier" stroke-width="0"></g> <g id="SVGRepoEditor" data-name="Box List"> <path d="M6.562,8.062h-2a1.5,1.5,0,0,1-1.5-1.5v-2a1.5,1.5,0,0,1,1.5-1.5h2a1.5,1.5,0,0,1,1.5,1.5v2A1.5,1.5,0,0,1,6.562,8.062Zm-2-4a.5.5,0,0,0-.5.5v2a.5.5,0,0,0,.5.5h2a.5.5,0,0,0,.5-.5v-2a.5.5,0,0,0-.5-.5Z"></path> <path d="M6.562,20.938h-2a1.5,1.5,0,0,1-1.5-1.5v-2a1.5,1.5,0,0,1,1.5-1.5h2a1.5,1.5,0,0,1,1.5,1.5v2A1.5,1.5,0,0,1,6.562,20.938Zm-2-4a.5.5,0,0,0-.5.5v2a.5.5,0,0,0,.5.5h2a.5.5,0,0,0,.5-.5v-2a.5.5,0,0,0-.5-.5Z"></path> <path d="M6.562,14.5h-2a1.5,1.5,0,0,1-1.5-1.5V11a1.5,1.5,0,0,1,1.5-1.5h2a1.5,1.5,0,0,1,1.5,1.5v2A1.5,1.5,0,0,1,6.562,14.5Zm-2-4a.5.5,0,0,0-.5.5v2a.5.5,0,0,0,.5.5h2a.5.5,0,0,0,.5-.5V11a.5.5,0,0,0-.5-.5Z"></path> <path d="M20.438,6.062h-9a.5.5,0,0,1,0-1h9a.5.5,0,0,1,0,1Z"></path> <path d="M20.438,12.5h-9a.5.5,0,0,1,0-1h9a.5.5,0,0,1,0,1Z"></path> <path d="M20.438,18.935h-9a.5.5,0,1,1,0-1h9a.5.5,0,0,1,0,1Z"></path> </g></svg>
				...
				<div class="p-6 mega-menu mb-16 sm:mb-0 shadow-xl bg-gradient-to-r from-blue-500 to-blue-900">
					<div class="grid grid-cols-5 m-auto">
					<img src={kNav} alt="nav kids img" class="w-48 pl-10" />
					<div>
					...
					<div class="grid grid-cols-1 p-2">
						...
						<a class="font-base underline text-xl" href="/shop?sort=Trending&type=Kids">Trending</a>
					...
					<div class="grid grid-cols-1 p-2">
						...
						<a class="font-base underline text-xl" href="/shop?query=Nike&type=Kids">Nike</a>
						<a class="font-base underline text-xl" href="/shop?query=Adidas&type=Kids">Adidas</a>
						<a class="font-base underline text-xl" href="/shop?query=Puma&type=Kids">Puma</a>
						<a class="font-base underline text-xl" href="/shop?query=Under%20Armour&type=Kids">Under Armour</a>
					</div>
					<div class="grid grid-cols-1 p-2">
						<div class="font-semibold text-4xl flex">
			...
			<div class="navbar-end">
				...
				<label tabindex={0} class="btn btn-ghost btn-circle ml-3 mr-1">
					<div class="indicator">
				...
				<div class="dropdown dropdown-end">
					<label tabindex={0} class="btn btn-ghost btn-circle ml-1 mr-3">
					<div class="indicator">
					...
					{/* {#each CartProducts as product}
						<div class="grid grid-cols-6">
						<a href="/product/{product.id}" class="transition ease-in-out delay-15 duration-300 py-2 col-span-5">
							<div class="text-md">
