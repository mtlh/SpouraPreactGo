    ...
    return (
        <>
            <div class="grid grid-cols-1">
                ...
                <a href="/checkout" class="m-auto text-center"><button class="btn bg-gradient-to-r from-blue-500 to-blue-900 border-0 rounded-lg m-auto text-center text-white">Checkout</button></a>
            </div>
                    ...
                    <>
                        {user.Cart.map((product) => (
                            <div class="grid grid-cols-1 md:grid-cols-3 shadow-lg ring-1 ring-slate-400 p-4 rounded-lg my-2">
                                ...
                                <a onClick={async ()=> updateCart(await RemoveFromCart(product.urlslug, product.quantity, product.size), setuser, setRemoveLoading)} class="m-auto hover:cursor-pointer">
